...
parser.add_argument('--coco_json', required=False, help='Target json file to convert to csv.')
parser.add_argument('--coco_folder', required=False, default='', help='Target folder to find images.')
parser.add_argument('--save_xml', required=False, help='The folder to save annotations xmls.')
...
parser.add_argument('--no_skip_background', dest='skip_background', action='store_false',
                    help='Do not skip \'background\' category.')
