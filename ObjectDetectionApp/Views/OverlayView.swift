...
//      drawName(of: objectOverlay)
  ...
  func drawName(of objectOverlay: ObjectOverlay) {
    ...
    // Draws the string.
      let stringRect = CGRect(x: objectOverlay.borderRect.size.height + stringHorizontalSpacing + 20, y: objectOverlay.borderRect.size.height , width: objectOverlay.nameStringSize.width, height: objectOverlay.nameStringSize.height)
